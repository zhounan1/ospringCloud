package com.aust.security.openId;
...
public class OpenIdAuthenticationFilter extends AbstractAuthenticationProcessingFilter {
    ...
    public static final String PROVIDER_ID_KEY = SecurityConstants.DEFAULT_REQUEST_PARAMETER_PROVIDER_ID;

    private String openIdParameter = OPENID_KEY;
    private String providerIdParameter = PROVIDER_ID_KEY;
